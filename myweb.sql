/*
 ...
 Source Schema         : gougucms1

 Target Server Type    : MySQL
 Target Server Version : 50726
 File Encoding         : 65001

 Date: 06/11/2023 08:51:09
*/
...
-- ----------------------------
INSERT INTO `cms_admin` VALUES (1, 'admin', '1bb8811bb4ad8cee14475c59d2df9d2c', '8E3dgsvr0YRT46filNFJ', '超级管理员', '/static/admin/images/icon.png', 'black', 0, '', NULL, 1, 1, 1699194293, 1699194293, 1699226205, 6, '127.0.0.1', 1);
INSERT INTO `cms_admin` VALUES (2, 'macro', 'c3ba8d31b12b1ea99ae9ab3d55e44155', '6zBPUe2FZjpNHDtaCyfu', '曾辉', '/storage/avatars/avatar_256_H7elKyuFGO1699194768.png', 'black', 13111111111, '', '', 1, 1, 0, 0, 1699228379, 7, '127.0.0.1', 1);
...
CREATE TABLE `cms_admin_group`  (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '权限分组表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cms_admin_group
-- ----------------------------
INSERT INTO `cms_admin_group` VALUES (3, '管理员', 1, '1,17,18,19,20,21,22,29,30,31,32,4,79,80,81,82,83,84,85,5,88,89,90,91,92,93,94,95,96,6,97,98,99,100,101,102,103,104,105', '', 0, 0);
...
CREATE TABLE `cms_admin_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 105 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '后台操作日志表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cms_admin_log
-- ----------------------------
INSERT INTO `cms_admin_log` VALUES (102, 2, '曾辉', 'delete', '删除', '权限角色', '删除', '曾辉在2023-11-06 07:31:06删除了权限角色', 'admin', 'role', 'delete', '', '127.0.0.1', 2, '[]', 1, 1699227066);
INSERT INTO `cms_admin_log` VALUES (103, 2, '曾辉', 'login', '登录', '系统', '', '曾辉在2023-11-06 07:51:42登录了系统', 'admin', 'login', 'login_submit', '', '127.0.0.1', 2, '{\"last_login_time\":1699228302,\"last_login_ip\":\"127.0.0.1\",\"login_num\":6}', 1, 1699228302);
INSERT INTO `cms_admin_log` VALUES (104, 2, '曾辉', 'login', '登录', '系统', '', '曾辉在2023-11-06 07:52:59登录了系统', 'admin', 'login', 'login_submit', '', '127.0.0.1', 2, '{\"last_login_time\":1699228379,\"last_login_ip\":\"127.0.0.1\",\"login_num\":7}', 1, 1699228379);
...
CREATE TABLE `cms_admin_rule`  (
  ...
  `update_time` int(11) NOT NULL DEFAULT 0 COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 120 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单及权限表' ROW_FORMAT = Dynamic;
...
INSERT INTO `cms_file` VALUES (5, 'admin', 'b96c9d8818988657e422c1265d9df87774403b51', '7d5c38fc70644080a39a21460ab47ea7', '2023.1学期课表.xlsx', '202311/7d5c38fc70644080a39a21460ab47ea7.xlsx', '/storage/202311/7d5c38fc70644080a39a21460ab47ea7.xlsx', 30575, 'xlsx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 0, 1, '127.0.0.1', 1, 1699194428, 1, 0, 1699194428, 'upload', 'thumb', 0);
...
CREATE TABLE `cms_file_group`  (
  ...
  `delete_time` int(11) NOT NULL DEFAULT 0 COMMENT '删除时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '文件分组表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of cms_file_group
-- ----------------------------
INSERT INTO `cms_file_group` VALUES (1, '113', 0, 0, 0, 0);
...
INSERT INTO `cms_gallery_cate` VALUES (2, '11', 0, 1, '111', '11', 1699194628, 0, 0);
...
CREATE TABLE `cms_user_log`  (
  ...
  `create_time` int(11) NOT NULL DEFAULT 0 COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '用户操作日志表' ROW_FORMAT = Dynamic;
